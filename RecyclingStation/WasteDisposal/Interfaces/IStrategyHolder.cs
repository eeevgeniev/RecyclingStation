namespace RecyclingStation.WasteDisposal.Interfaces
{
    ...
    {
        /// <summary>
        /// Return IGarbageDisposalStrategy base on it's DisposableAttribute attribute type
        /// </summary>
        /// <param name="type">Attribute which inherits from DisposableAttribute</param>
        /// <returns></returns>
        IGarbageDisposalStrategy GetDisposalStrategy(Type type);
